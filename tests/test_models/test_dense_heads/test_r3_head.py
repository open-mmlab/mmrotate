...
class TestR3Head(TestCase):
    ...
    def test_r3_head_filter_bboxes(self):
        """Tests the `filter_bboxes` function of R3Head."""

    def test_r3_refine_head_loss(self):
        """Tests r3 refine head loss when truth is empty and non-empty."""
        s = 256
        img_metas = [{
            'img_shape': (s, s, 3),
            'pad_shape': (s, s, 3),
