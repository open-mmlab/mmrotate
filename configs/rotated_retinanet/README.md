...
## Introduction
- `hbb` means the input of the assignor is the predicted box and the horizontal box that can surround the GT. 
- `obb` means the input of the assignor is the predicted box and the GT. 
