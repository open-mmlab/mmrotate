...
# # _base = './rotated-retinanet-rbox-h180_r50_fpn_6x_rl1_dota_pt.py'
# _base = './rotated-retinanet-rbox-h180_r50_fpn_6x_rl1_dota.py'
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='RL1Loss', loss_weight=10.0)),
    train_cfg=dict(
        assigner=dict(
